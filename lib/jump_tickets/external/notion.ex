...
defmodule JumpTickets.External.Notion.Parser do
  ...
  def parse_ticket_page(page) do
    ...
    %Ticket{
      ...
      done: Map.get(properties, "Done") |> extract_checkbox()
    }
  end
  ...
  defp extract_checkbox(nil), do: false
  defp extract_checkbox(%{"checkbox" => value}), do: value
  defp extract_checkbox(_), do: false
end
